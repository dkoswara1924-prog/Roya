...
const dataLatihan = [
  ...
  },
  {
    ...
    wazan: "يستفعل",
    contoh: "يستخلف ، يستغفر ، يستسلم ، يستنبmagnetic ، يستأذن ، يستأنف ، يستهزأ ، يستخدم ، يستعمر ، يستظهر ، يستفهم ، يستحسن ، يستكشف ، يستطلع ، يستعبد ، يستلزم ، يستمتع ، يستذكر ، يستغرق ، يستعمل ، يستمسك ، يستحضر ، يستطعم ، يستبشر ، يسترجع ، يسترشد ، يستخلص ، يستدرك ، يستكبر ، يستقرأ ، يستحضر ، يستقبل ، يستشهد ، يستشكل"
  }
];

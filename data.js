...
const dataLatihan = [
  ...
  // ------------------------------------------------------------
  {
    ...
    contoh: "فَعَلَ فَعَلَا فَعَلُوْا فَعَلَتْ فَعَلَتَا فَعَلْنَ فَعَلْتَ فَعَلْتُمَا فَعَلْتُمْ فَعَلْتِ فَعَلْتُمَا فَعَلْتُنَّ فَعَلْتُ فَعَلْنَا | نَصَرَ نَصَرَا نَصَرُوْا نَصَرَتْ نَصَرَتَا نَصَرْنَ نَصَرْتَ نَصَرْتُمَا نَصَرْتُمْ نَصَرْتِ نَصَرْتُمَا نَصَرْتُنَّ نَصَرْتُ نَصَرْنَا | نصر خلق رزق رفع صنعا سلكا سترا قتلا عبدوا ضربوا لفظوا عرفوا قرئوا سبقت ربطت منعت فتحت سألت فَعِلَتَا علمتا فهمتا رحمتا سمعتا فَعُلْنَ حسن صعبن كبرن صغرن أَفْعَلْتَ أكرمت أحسنت ادركت أخرجت أكملتما أعلمتما ألزمتما أشرفتما أدبرتما فَعَّلْتُمْ نفذتم طبقتم كبرتم عظمتم سهلتِ رتلتِ حسنتِ حررتِ شرفتِ كلمتما علمتمـا جودتما نبهتما سبحتما جردتُنَّ غيرتن دبرتن ركزتن نظمتن فَاعَلْتُ قاتلتُ شاورتُ شاركتُ صاحبتُ جاهدنا جالسنا عاملنا طالعنا دارسنا صارع حاولا خالفوا عالجتْ حافظتا انْفَعَلْنَ انكسرتْ انسجمتما انفتحتم انبسطتِ انبثقتما انفصلتن انعقدتُ انخفضنا انقلب انخذلا انشرحوا انفطرتْ انقطعتا انحرفن افْتَعَلْتَ اجتمعتمـا احترمتم اقتصدتِ اجتهدتما اقتصرتن اختلفتُ اشتملنا انتخب اعتبرا انتصروا امتثلتْ اعترضتَا احتسبن اعتمدتَّ افْعَلَّ احمرا اصفروا اسودتْ احضرتا تَفَعَّلَ تحدثا تكلموا تقيدتْ تعلقتـا تبرجن تخرجتَ تقدمتَ تدبرتما تفكرتم تَفَاعَلْتِ تقاتلتِ تنازعتما تناقضتن تخاصمتُ تدافعنا تراسل تضاربا تفائلوا تشائمتْ اسْتَفْعَلَتَا استخلفن استغفرتَ استسلمتما استنبطتم استكبرتِ استأذنتما استأنفتن استهزئتُ استخدمنا استقرئوا استعمرا استظهرتَ استفهمتِ استحسنتْ"
  },
  {
    level: 2,
    ...
    contoh: "نصرا خلقوا رزقن رفعتَ تركتُ صنعتِ سلكنا سترتم قتلتن عبدوا ضربن لفظتا عرفتم قرئتما سبقا ربطن منعوا فتحتم سألتم فَعِلَ علموا فهمتَ رحمتْ سمعتن فَعُلَ حسنتْ صعبوا كبرتم صغرتن أَفْعَلَ أكرمتُ أحسنتم ادركتُ أخرجوا أكملا أعلموا ألزمتِ أشرفتما أدبرتم فَعَّلَ نفذتْ طبقا كبرن عظمتم سهلتَ رتلتِ حسنتُ حررتن شرفتم كلما علمتا جودوا نبهتم سبحتِ جردا غيروا دبرتم ركزتَ نظمتما فَاعَلَ قاتلا شاوروا شاركتَ صاحبتم جاهدوا جالستُ عاملتما طالعتِ دارستا صارعن حاولتن خالفتْ عالجوا حافظتم انْفَعَلَ انكسرتْ انسجمتَ انفتحتم انبسطوا انبثقوا انفصلتن انعقدوا انخفضتْ انقلبتم انخذلوا انشرحتم انفطرتمـا انقطعا انحرفا افْتَعَلَ اجتمعا احترموا اقتصدتْ اجتهدتَ اقتصرتْ اختلفتن اشتملتِ انتخبتم اعتبرتما انتصروا امتثلتِ اعترضتَ احتسبتُ اعتمدتم افْعَلَّ احمرا اصفروا اسودتْ احضرتا تَفَعَّلَ تحدثا تكلمتم تقيدنا تعلقتم تبرجتن تخرجن تقدمتَ تدبروا تفكرتن تَفَاعَلَ تقاتلنا تنازعا تناقضتن تخاصمتم تدافعا تراسلتم تضاربتا تفائلتما تشائمتِ اسْتَفْعَلَ استخلفوا استغفرتَ استسلمتِ استنبطا استكبرنا استأذنتُ استأنفتم استهزئتن استخدموا استقرئوا استعمرا استظهرتَ استفهمتِ استحسنتْ"
  }
];
